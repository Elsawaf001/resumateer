            ...
            <div className="container max-w-5xl">
                <div className="border border-white/15 rounded-[27px] md:rounded-full bg-neutral-950/70 backdrop-blur">
                    ...
                    <div className="flex justify-end gap-4">
                     ...
                     <button className="border  h-12 rounded-full px-6 font-medium border-white text-white bg-transparent hidden md:inline-flex items-center" >Log In</button>
                     <button className="border  h-12 rounded-full px-6 font-medium bg-lime-400 text-neutral-950 border-lime-400 hidden md:inline-flex items-center">Sign Up</button>
                             ...
                             {isMenuOpen && (
                                    ...
                                    <button className="border  h-12 rounded-full px-6 font-medium border-white text-white bg-transparent  md:inline-flex items-center" >Log In</button>
                                     <button className="border  h-12 rounded-full px-6 font-medium bg-lime-400 text-neutral-950 border-lime-400  md:inline-flex items-center">Sign Up</button>
