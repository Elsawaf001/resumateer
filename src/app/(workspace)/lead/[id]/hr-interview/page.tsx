import { generateCoverLetter, generateHRInterview, generateSalaryReport } from '@/actions/lead'
...
async function Page(props: CoverPageProps) {
    ...
    const contentAI = await generateHRInterview(lead ? lead?.title + lead?.content : "", params.id, lead ? lead.title : "")
