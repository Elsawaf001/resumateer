    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <Card className="max-w-4xl w-full shadow-lg p-6">
        <CardContent>
          ...
          <h2 className="text-xl font-semibold mb-3">Free Tier Usage</h2>
          <p className="mb-4 text-gray-600">
          ...
          <p className="mb-4 text-gray-600">
            To request a refund, please contact our support team at <a href="mailto:support@resumateer.com" className="text-blue-500 underline">elsawaf001@gmail.com</a>. Include the following details in your request:
          </p>
          <ul className="list-disc list-inside mb-4 text-gray-600">
          ...
          <h2 className="text-xl font-semibold mb-3">Non-Refundable Conditions</h2>
          <p className="mb-4 text-gray-600">
